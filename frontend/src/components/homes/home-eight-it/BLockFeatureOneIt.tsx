...
const feature_data: DataType[] = [
  ...
  },
  {
    ...
    desc: <>Vendi la tua proprietà rapidamente al miglior prezzo di mercato.</>,
  },
  {
    id: 3,
    icon: icon_3,
    title: "Processo rapido",
    desc: <>Ci vogliono solo pochi minuti per acquistare o vendere con CERVANTES REAL ESTATE.</>,
  },
];

const BLockFeatureOneIt = () => {
  return (
...
export default BLockFeatureOneIt;
