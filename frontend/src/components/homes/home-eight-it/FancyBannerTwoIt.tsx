          ...
          <div className="col-xl-8 m-auto text-center">
            <div className="title-one mb-40 lg-mb-20">
              <h2 className="font-garamond fs-xl text-white">
                Hai una domanda? <br /> Mettiti in contatto con noi.
              </h2>
            </div>
            <Link href="/it/contact" className="btn-nine text-uppercase">
...
export default FancyBannerTwoIt;
