               ...
               <div className="col-lg-6 d-flex order-lg-last">
                  <div className="ps-xxl-5 ms-xl-4 pt-100 xl-pt-80 pb-45 w-100 h-100 wow fadeInRight">
                     <div className="title-one mb-60 lg-mb-40">
                        <div className="upper-title">ÉVALUATIONS</div>
                        <h3>Évaluations <span>réalisées<Image src={titleShape} alt="" className="lazy-img" /></span> pour votre propriété.</h3>
                        <p className="fs-24 color-dark">Obtenez une évaluation précise et accédez au marché immobilier en toute confiance.</p>
                     </div>
                     <form onSubmit={(e) => e.preventDefault()} className="me-xl-4">
                        <input type="email" placeholder="Votre adresse e-mail..." />
                        <button>Découvrir</button>
                     </form>
                     <div className="fs-16 mt-10 opacity-75">*Pour des informations précises, veuillez <Link href="/fr/contact" className="fst-italic color-dark text-decoration-underline">nous contacter.</Link></div>
                  </div>
               </div>
                  ...
                  <div className="img-gallery position-relative z-1 w-100 h-100 me-lg-5 wow fadeInLeft">
                     ...
                     <div className="card-one">
                        <div className="text text-center z-1">
                           <h6>Votre évaluation à partir de :</h6>
                           <h3>$2,900.00</h3>
                        </div>
...
export default BLockFeatureFourFr
