          ...
          <div className="col-lg-4">
            <div className="d-flex align-items-center md-mb-30 gap-4 flex-wrap">
              ...
              <div className="ps-3 text" style={{ width: "auto", flex: "1 1 240px" }}>
                ...
                <span className="fs-20">Gründer & CEO von CERVANTES REAL ESTATE</span>
              </div>
            </div>
          </div>
          <div className="col-xxl-7 col-lg-8">
            <blockquote>&quot;Wir folgen einem strengen Prozess, um unseren Anlegern die besten Chancen zu bieten.&quot;</blockquote>
          </div>
        </div>
        ...
        <div className="fact-wrapper d-flex flex-wrap mt-60 md-mt-40">
          <div className="fact-box">
            <div className="text-meta text-sm-start d-inline-block">
              ...
              <span>Grundstücke analysiert</span>
            </div>
          </div>
          <div className="fact-box">
            <div className="text-meta text-sm-start d-inline-block">
              <div className="numb">0.2%</div>
              <span>Bestanden die erste Prüfung</span>
            </div>
          </div>
          <div className="fact-box">
            <div className="text-meta text-sm-start d-inline-block">
              <div className="numb">15%</div>
              <span>Vom Komitee genehmigt</span>
            </div>
          </div>
          <div className="fact-box">
            <div className="text-meta text-sm-start d-inline-block">
...
export default FancyBannerOneDe;
