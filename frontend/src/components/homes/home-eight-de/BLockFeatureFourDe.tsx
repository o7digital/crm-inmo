               ...
               <div className="col-lg-6 d-flex order-lg-last">
                  <div className="ps-xxl-5 ms-xl-4 pt-100 xl-pt-80 pb-45 w-100 h-100 wow fadeInRight">
                     <div className="title-one mb-60 lg-mb-40">
                        <div className="upper-title">WERTERMITTLUNG</div>
                        <h3>
                          Gutachten <span>fertig<Image src={titleShape} alt="" className="lazy-img" /></span> für Ihre Immobilie.
                        </h3>
                        <p className="fs-24 color-dark">Erhalten Sie eine präzise Bewertung und treten Sie selbstbewusst am Markt auf.</p>
                     </div>
                     ...
                     <div className="fs-16 mt-10 opacity-75">
                        *Für genaue Informationen bitte{" "}
...
export default BLockFeatureFourDe
