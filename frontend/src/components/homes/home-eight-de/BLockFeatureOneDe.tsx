...
const feature_data: DataType[] = [
  {
    ...
    icon: icon_1,
    title: "2M+ Immobilien",
    desc: <>Rechtsberatung für Immobiliengeschäfte in Mexiko, Miami und Madrid.</>,
  },
  {
    id: 2,
    icon: icon_2,
    title: "Kauf & Miete",
    desc: <>Verkaufen Sie Ihre Immobilie schnell und zum bestmöglichen Marktpreis.</>,
  },
  {
    id: 3,
    icon: icon_3,
    title: "Schneller Prozess",
    desc: <>Mit CERVANTES REAL ESTATE kaufen oder verkaufen Sie in wenigen Minuten.</>,
  },
];

const BLockFeatureOneDe = () => {
  return (
    <div className="block-feature-one mt-150 xl-mt-120">
      <div className="container container-large">
        <div className="title-one text-center mb-60 xl-mb-30 lg-mb-20 wow fadeInUp">
          <h3>Finden Sie das perfekte Zuhause</h3>
          <p className="fs-24">Ihr verlässlicher Immobilienpartner bei jeder Transaktion.</p>
        </div>
...
export default BLockFeatureOneDe;
