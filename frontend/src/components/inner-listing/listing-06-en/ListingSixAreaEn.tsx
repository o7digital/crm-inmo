    ...
    properties.forEach((prop) => {
      if (prop?.property_type) {
        ...
        if (normalized && !propertyTypes.has(normalized)) {
          const localized = localizePropertyTitle(prop.property_type.toString().trim(), "en");
        ...
        <div className="listing-filters mb-40">
          <div className="row g-3 align-items-end">
            <div className="col-12 col-md-4 col-lg-3">
              <label htmlFor="listing-type-filter-en" className="form-label fw-500">
                Type / Operation
              </label>
              <select
                id="listing-type-filter-en"
            ...
            <div className="col-6 col-md-4 col-lg-2">
              <label htmlFor="listing-min-price-en" className="form-label fw-500">
                Min amount
              </label>
              <input
                id="listing-min-price-en"
                type="number"
            ...
            <div className="col-6 col-md-4 col-lg-2">
              <label htmlFor="listing-max-price-en" className="form-label fw-500">
                Max amount
              </label>
              <input
                id="listing-max-price-en"
                type="number"
                className="form-control"
            ...
            <div className="col-12 col-md-6 col-lg-3">
              <label htmlFor="listing-location-filter-en" className="form-label fw-500">
                Location
              </label>
              <input
                id="listing-location-filter-en"
                className="form-control"
                value={inputs.location}
                onChange={handleInputChange("location")}
                list="listing-location-options-en"
                placeholder="Type location or leave empty for all"
              />
              <datalist id="listing-location-options-en">
